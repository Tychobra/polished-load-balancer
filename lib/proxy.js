  ...
  constructor (config) {
    ...
    proxyOptions.onProxyReqWs = (proxyReq, req, socket, options, head) => {
      ...
      if (req.shinyAppSession) {
        ...
        //console.log("sessionId:", req.shinyAppSession.sessionId)
        //proxyReq.setHeader('Set-Cookie', `SHINYAPP_SESSION=${req.shinyAppSession.sessionId}`)
        //console.log("session: ", req.shinyAppSession)
