...
export class ShinyApp {
  ...
  constructor(config) {
    ...
    // every minute (make this longer in future),  check nActiveSessions of each instance, and
  ...
  */
  async getSession (id=null) {
    ...
    if (id && this.sessions[id]) {
      ...
      //console.log("instanceMinSessions: ", instanceMinSessions)      
